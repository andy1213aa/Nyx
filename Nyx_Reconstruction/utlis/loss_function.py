...
def generator_loss(fake_logit, real_data, fake_data_by_real_parameter):
    ...
    l2_norm =tf.reduce_mean(tf.math.sqrt(tf.reduce_sum(((fake_data_by_real_parameter-real_data[1])**2), axis = (1, 2, 3)))) #/ (fake_data_by_real_parameter.shape[0]*fake_data_by_real_parameter.shape[1]*fake_data_by_real_parameter.shape[2]*fake_data_by_real_parameter.shape[3])
